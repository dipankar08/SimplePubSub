            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _b.label = 1;
                    case 1:
                        if (!(_i < testcase_1.length)) return [3 /*break*/, 12];
                        tc = testcase_1[_i];
                        // replace arguments
                        this.cur_tc = tc;
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 11];
                    case 5: return [4 /*yield*/, this.handleGet(tc.arguments, this.result)];
                    case 6:
                        _b.sent();
                        return [3 /*break*/, 11];
                    case 7: return [4 /*yield*/, this.handlePOST(tc.arguments, this.result)];
                    case 8:
                        _b.sent();
                        return [3 /*break*/, 11];
                    case 9: return [4 /*yield*/, this.executeTest(tc)];
                    case 10:
                        _b.sent();
                        return [3 /*break*/, 11];
                    case 11:
