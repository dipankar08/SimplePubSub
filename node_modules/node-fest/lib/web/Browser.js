...
exports.getWebDriver = exports.EBrowserType = void 0;
var EBrowserType;
...
function getChromeDriver(context) {
    return __awaiter(this, void 0, void 0, function () {
        var driverPath, chromeOption, driver;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    driverPath = chromeDriver.path;
                    chromeOption = new chrome.Options().windowSize(windowSize).addArguments('--incognito');
...
function getFireFoxDriver(context) {
    return __awaiter(this, void 0, void 0, function () {
        var driverPath, chromeOption, driver;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    chromeOption = new firefox.Options().windowSize(windowSize).setPreference('browser.privatebrowsing.autostart', true);
                    updateOption(chromeOption, context);
                    return [4 /*yield*/, new selenium_webdriver_1.Builder()
        ...
        return __generator(this, function (_a) {
            switch (context.browser) {
                case EBrowserType.Chrome:
                    return [2 /*return*/, getChromeDriver(context)];
                case EBrowserType.Firefox:
                    return [2 /*return*/, getFireFoxDriver(context)];
                default:
...
function updateOption(option, context) {
